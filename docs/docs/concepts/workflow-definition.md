...
- [States and Transitions](./states-and-transitions) — state categories, conditional transitions, auto-continuation
...
- [WorkflowModule API](../api-reference/workflow-module) — full module reference
