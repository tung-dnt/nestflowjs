...
const config: Config = {
  ...
  projectName: 'nestflow', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/tung-dnt/nestflow/tree/main/docs/',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://www.npmjs.com/package/nestflow',
          label: 'NPM',
          position: 'right',
        },
      ],
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'Contributing',
              href: 'https://github.com/tung-dnt/nestflow/blob/main/CONTRIBUTING.md',
            },
            {
              label: 'Changelog',
              href: 'https://github.com/tung-dnt/nestflow/blob/main/CHANGELOG.md',
            },
            {
              label: 'License',
              href: 'https://github.com/tung-dnt/nestflow/blob/main/LICENSE',
            },
          ],
        },
      ],
