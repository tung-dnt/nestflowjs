...
[![npm version](https://img.shields.io/npm/v/nestflow.svg)](https://www.npmjs.com/package/nestflow)
...
```bash
# Using bun
bun add nestflow @nestjs/common @nestjs/core reflect-metadata rxjs

# Using npm
npm install nestflow @nestjs/common @nestjs/core reflect-metadata rxjs

# Using yarn
yarn add nestflow @nestjs/common @nestjs/core reflect-metadata rxjs
```
...
import { IWorkflowEntity } from 'nestflow/core';
...
📚 **[Full Documentation](https://tung-dnt.github.io/nestflow/)**

- [Getting Started](https://tung-dnt.github.io/nestflow/docs/getting-started)
- [Workflow Module](https://tung-dnt.github.io/nestflow/docs/workflow)
- [Lambda Adapter](https://tung-dnt.github.io/nestflow/docs/adapters)
- [API Reference](https://tung-dnt.github.io/nestflow/docs/api-reference/workflow-module)
- [Examples](https://tung-dnt.github.io/nestflow/docs/examples/lambda-order-state-machine)
...
import { WorkflowModule, IWorkflowEvent } from 'nestflow/core';

// Adapter — base class + built-in durable Lambda adapter
import { BaseWorkflowAdapter, DurableLambdaEventHandler } from 'nestflow/adapter';

// Exceptions
import { UnretriableException } from 'nestflow/exception';
```
...
```typescript
import { BaseWorkflowAdapter } from 'nestflow/adapter';
import { OrchestratorService } from 'nestflow/core';
import type { IWorkflowEvent, TransitResult } from 'nestflow/core';
...
The built-in `DurableLambdaEventHandler` extends this base with AWS checkpointing and `waitForCallback()` support. See the [Custom Adapter recipe](https://tung-dnt.github.io/nestflow/docs/recipes/custom-adapter) for full examples.

## Examples

Check out the [examples directory](https://github.com/tung-dnt/nestflow/tree/main/examples) for complete working examples:

- **[Lambda Order State Machine](https://github.com/tung-dnt/nestflow/tree/main/examples/lambda-order-state-machine/)**: Complete AWS Lambda example with DynamoDB and durable execution
...
Events trigger state transitions. The `IWorkflowEvent` interface (from `nestflow/core`) defines the shape of workflow events:
...
Contributions are welcome! Please read our [Contributing Guide](https://github.com/tung-dnt/nestflow/tree/main/CONTRIBUTING.md) for details on:
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/tung-dnt/nestflow/tree/main/LICENSE) file for details.
...
- Repository: [nestflow](https://github.com/tung-dnt/nestflow)

## Support

- 📖 [Documentation](https://tung-dnt.github.io/nestflow/)
- 🐛 [Issue Tracker](https://github.com/tung-dnt/nestflow/issues)
- 💬 [Discussions](https://github.com/tung-dnt/nestflow/discussions)
