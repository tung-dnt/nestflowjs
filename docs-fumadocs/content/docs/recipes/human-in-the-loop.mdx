...
description: Pause a workflow for human approval and resume it via an external callback.
---
...
See [Testing with MockDurableContext](/docs/plugins/durable-lambda#testing-with-mockdurablecontext) for the full mock implementation.
