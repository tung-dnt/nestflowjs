---
title: Services
description: Core services provided by the workflow module including OrchestratorService and StateRouterHelperFactory.
---
...
Promise resolving to a `TransitResult` indicating the workflow outcome (`final`, `idle`, `continued`, or `no_transition`). See [TransitResult](/docs/api-reference/adapters#transitresult) for details.
